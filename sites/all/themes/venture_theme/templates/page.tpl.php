...
<div id="wrap">
  <div id="user-menu-wrap">
	<div id="user-menu" class="clr container">
  ...
  <footer id="copyright-wrap" class="clear">
    ...
    <div><?php print t('Website developed by '); ?><a href="http://www.hyperluminal.co.uk" title="Hyperluminal" target="_blank">Hyperluminal Ltd</a>.</div>
  </footer>
</div>